...
const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    answer: 'Вы можете узнать адрес лотереи на сайте. Она появится там после создания и вы будете указаны ее создателем'
  },
  {
    question: 'Как создать лотерею?',
    answer: 'Для создания своей лотереи воспользуйтесь формой на сайте.\nПервым шагом необходимо создать сам контракт лотереи: для этого укажите необходимые параметры и подтвердите транзакцию.\nДалее вам необходимо узнать адрес контракта созданной лотереи и NFT, который вы хотите разыграть.\nБудьте внимательны с адресом контракта лотереи!'
  },
  {
